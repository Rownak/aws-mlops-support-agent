...
## Progress
After each phase complete or when instructed, write a very concise 2-3 lines about what has been done for that phase in progress.md in packages root folder.