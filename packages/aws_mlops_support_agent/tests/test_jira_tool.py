"""Tests for the Jira REST wrapper. Fully offline: requests.post is
monkeypatched, never actually called over the network.
"""

import pytest
from aws_mlops_support_agent.agent import jira_tool
...
def _cfg(**overrides) -> AgentConfig:
    """A fully-configured Jira setup; individual tests blank out fields."""
    fields = {
