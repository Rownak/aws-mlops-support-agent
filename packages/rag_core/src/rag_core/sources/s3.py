...
Needs boto3: ``pip install rag-core[s3]``. Credentials are resolved by boto3's
normal chain, so environment variables, a shared credentials file, or an
instance role all work without RagCore knowing about them.
"""
...
DEFAULT_CACHE_DIR = ".rag_core_cache"
...
class S3Source(Source):
    ...
    Example:
        ...
        ['.rag_core_cache/filings/2026/apple_10k.pdf']
    """
    ...
    def __init__(
        ...
        **_ignored,
        ...
        try:
            ...
            raise ImportError(
                "The s3 source requires boto3. Install it with: pip install rag-core[s3]"
            ) from exc
